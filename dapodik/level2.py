...
df = pd.DataFrame({'link': linkArray, 'kode kecamatan': kodeWilayah2,'kecamatan':kecamatanArray, 'kode kab/kota':kode_wilayah1,'kab/kota':kabArray})

# writer = pd.ExcelWriter('dapodik-level-2.xlsx')
# df.to_excel(writer,'Sheet1',index=False)

df.to_excel('dapodik-level-2.xlsx', index=False, sheet_name='Sheet1')
